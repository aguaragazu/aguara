...
class Validation
{
    ...
    private function isEmpty($value)
    {
        ...
        } elseif (empty($value) && '0' !== $value && false !== $value && 0 !== $value && 0.0 !== $value) {
            return true;
        } elseif (is_array($value) && isset($value['name'], $value['type'], $value['tmp_name'], $value['error'])) {
            return UPLOAD_ERR_NO_FILE === (int) $value['error'];
        }
    ...
    {
        return UPLOAD_ERR_OK === (int) $file['error'];
    }
